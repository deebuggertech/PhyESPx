...
/** General Variables**/
let sensorID = 2;
let sensorName = "Current Sensor";

/** Global Export Configuration **/
function clearExportDataSet() {
  downloadData = "\"Time (s)\"; \"Current (mA)\" \r\n";
}

function appendDataToExportDataSet(data) {
  downloadData += (data.time+" ; "+data.current+" \r\n").replaceAll(".", ",");
}
...
var views = [{
    ...
    "elements": [{
            "index": "0",
            "html": "<div style=\"font-size:120.0%;\" class=\"graphElement view0\" id=\"element0\"><span class=\"label\" onclick=\"toggleExclusive(0);\">Current</span><div class=\"graph\"><canvas id=\"chart0\"></canvas></div></div>",
        ...
        {
            "index": "1",
            "html": "<div class=\"valueElement view0\" id=\"element1\"><span class=\"label\">Current</span><span class=\"value\"></span><span class=\"unit\">mA</span></div>",
            "updateView": function(data) {
                var valueNumber = document.getElementById("element1").getElementsByClassName("value")[0];
                valueNumber.textContent = data.current.toFixed(1);
            },
            "clearView": function() {
                var valueNumber = document.getElementById("element1").getElementsByClassName("value")[0];
...

{
    ...
    "elements": [
        {
            "index": "2",
            "html": "<div class=\"textElement view1\" id=\"element2\"><span class=\"heading\">Current Sensor</span>The current sensor is based on the INA219 by Texas Instruments which is designed to measure currents of up to 3A with an resolution of 0.8mA.<br> Sampling frequency: 10Hz</div>"
        }
    ]
}
